...
```python
from fabsdk import MovieClient, MovieConfig

# Configuration avec l’URL de votre API (Render ou locale)
config = MovieConfig(movie_base_url="https://movie-api-9x1n.onrender.com")
...
- API Render : [https://movie-api-9x1n.onrender.com](https://movie-api-9x1n.onrender.com)
- PyPI : [https://pypi.org/project/fabsdk/](https://pypi.org/project/fabsdk/)